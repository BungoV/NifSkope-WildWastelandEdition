"""Commonwealth exterior cells whose EDID or FULL matches a word (read only). usage: cell_names.py <esm> <wrld formid hex, file-local> word [word ...]"""
import sys, struct, re
sys.path.insert(0, 'E:/Projects/NifskopeWildWastelandEdition/scratchpad/mountains_20260907')
import fo4esm
buf = fo4esm.load(sys.argv[1])
WS = int(sys.argv[2], 16)
words = [w.lower() for w in sys.argv[3:]]
