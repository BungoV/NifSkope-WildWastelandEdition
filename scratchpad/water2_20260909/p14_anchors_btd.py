# A COPY of scratchpad/rename_20260909/p14_anchors.py with ONE line changed:
# the DOCS list, because lane WATER2 owns docs/LODGEN_BTD_FORMAT.md and not
# docs/LODGEN_TERRAIN_VT.md, which another lane is writing into. The anchor
# pass itself is the skill's artefact and is not retyped.
#
...
DOCS = ["docs/LODGEN_BTD_FORMAT.md"]   # lane WATER2 owns only this page
