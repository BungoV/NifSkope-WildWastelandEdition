#!/usr/bin/env python
"""Lane SLAB1 -- the mask sheet's B channel (the far terrain's AO texel), read
...
re-implemented here.
    ...
    usage: mask_b_mean.py <finest.lodt> [name=x0,y0,x1,y1 ...]
           mask_b_mean.py <finest.lodt> --lattice <OBJH dump> [rects...]
