"""GREY1: material swaps in vanilla Fallout4.esm (read only). STAT/SCOL/MSTT MODL + MODS (base swap), every MSWP
...
refs = collections.Counter()      # (baseFid, xmsp or 0) -> count, Commonwealth only
...
pickle.dump(dict(base=base, mswp=mswp, refs=refs), open('esm_swaps.pkl', 'wb'))
