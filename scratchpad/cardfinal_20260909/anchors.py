...
SRC = {}
for f in ("src/lodtfile.cpp", "src/io/lodmfile.cpp", "src/io/lodmfile.h", "src/gl/glmesh.cpp",
          "src/lodgen.cpp", "src/nifskope_ui.cpp",
          ):
...
DOCS = ["docs/LODGEN_CARD_SHEETS.md", "docs/LODGEN_LODM_FORMAT.md"]
DEFAULT = {"docs/LODGEN_CARD_SHEETS.md": None,
