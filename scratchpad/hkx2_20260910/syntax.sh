#!/bin/bash
# Syntax-check lane HKX2's files with the REAL Makefile.Release flags (the same
...
# holds the GUI.
#   MSYSTEM=UCRT64 CHERE_INVOKING=1 /c/msys64/usr/bin/bash -lc 'cd /e/Projects/NifskopeWildWastelandEdition && bash scratchpad/hkx2_20260910/syntax.sh'
set -u
