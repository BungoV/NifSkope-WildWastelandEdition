#!/usr/bin/env python3
"""IDENTRES -- emit report.md.  Every figure below is copied from run.log /
rows.json / run_stdout.log, which are the lane's only sources of number."""
LANE = 'E:/Projects/NifskopeWildWastelandEdition/scratchpad/identres_20260919'

REPORT = r'''# IDENTRES -- the blocks are the test's resolution, not the identity
...
open(LANE + '/report.md', 'w', newline='\n').write(REPORT)
print('report.md %d bytes' % len(REPORT))
