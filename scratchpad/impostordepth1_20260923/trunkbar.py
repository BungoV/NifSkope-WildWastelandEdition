"""IMPOSTORDEPTH1 -- the pre-registered trunk bar + whole-tree numbers (progress.md, PRE-REGISTERED TRUNK BAR).
...
for arg in sys.argv[1:]:
    ...
    for a in az:
        ...
        C = mask(os.path.join(d, 'v_az%03d_el%02d_card.png' % (a, el)))
