...
for L in 0 1 2 3; do
	...
	WW_WINDOW_AT=1960,40 WW_LODL_OBJECTS="$V/urban/FO4CSLOD/Commonwealth/Commonwealth.lodi" \
	WW_LODL_SHEETS="$V/chunkB/vt/FO4CSLOD/Commonwealth" WW_LODL_REGION="4,-12,7,-9,$L" WW_LODI_LEVEL=$L \
