...
OUTPNG="E:/Projects/NifskopeWildWastelandEdition/scratchpad/cellview4b_20260919/images/after_downtown.png"
NOTES="$REPO/scratchpad/cellview4b_20260919/notes_downtown.txt"
PORT="${PORT:-14833}"
...
env WW_CELL_DATAROOT="$DATA" \
    ...
    > "$NOTES" 2>&1
echo "rc=$?"
ls -l "$REPO/scratchpad/cellview4b_20260919/images/after_downtown.png" 2>&1
