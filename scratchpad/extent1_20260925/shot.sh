...
ME=/e/Projects/NifskopeWWE-extent1
...
CACHE="C:/Users/bungo/AppData/Local/Temp/claude/E--Projects-Claude/b560e4ec-6e66-4c21-9572-1ad4acca0043/scratchpad/sheetcache_extent1_$(basename "$OUT" .png)_$(date +%s)"
...
rc=$?
if [ -s "$OUT" ]; then
  python "$(wp "$ME/scratchpad/extent1_20260925/frame_check.py")" "$(wp "$OUT")"
