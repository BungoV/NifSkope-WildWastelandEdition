#!/usr/bin/env python3
"""Lane UI6 -- the HANDOFF.md top-block text for the director to splice."""

TEXT = r'''- UI6 block, spliced 2026-09-11 (lane text verbatim):
...
with open('scratchpad/ui6_20260910/HANDOFF_BLOCK.md', 'w', encoding='utf-8', newline='\n') as f:
    f.write(TEXT)
print('wrote HANDOFF_BLOCK.md (%d chars)' % len(TEXT))
